...
class H5ImageDataset(data.Dataset):
    ...
    def get_data(self, index):
        ...
        if self.h5_file is None:
            self.h5_file = h5py.File(self.data_path, 'r')
        return self.h5_file['images']['image{:09d}'.format(index)][:], self.h5_file['sharp_images']['image{:09d}'.format(index)][:], self.h5_file['voxels']['voxel{:09d}'.format(index)][:]
    ...
    def __getitem__(self, index, seed=None):
        ...
        item['LQ_path'] = self.data_path + str(index)
