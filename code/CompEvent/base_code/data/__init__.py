...
def create_dataset(dataset_opt):
    ...
    elif mode == 'H5ImageDataset':
        from data.h5_image_dataset import H5ImageDataset as D

    elif mode == 'H5ImageDataset_raw':
        from data.h5_image_dataset_raw import concatenate_h5_datasets as D
        from data.h5_image_dataset_raw import H5ImageDataset as subD
        dataset = D(subD, dataset_opt)
