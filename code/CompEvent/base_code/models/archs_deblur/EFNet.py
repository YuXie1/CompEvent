...
class EFNet(nn.Module):
    def __init__(self, in_nc=3, wf=64, depth=3, fuse_before_downsample=True, relu_slope=0.2, num_heads=[1,2,4]):
        ...
        self.conv_01 = nn.Conv2d(in_nc, wf, 3, 1, 1)
        self.conv_02 = nn.Conv2d(in_nc, wf, 3, 1, 1)
        # event
        self.down_path_ev = nn.ModuleList()
        self.conv_ev1 = nn.Conv2d(6, wf, 3, 1, 1)
        ...
        self.last = conv3x3(prev_channels, in_nc, bias=True)

    def forward(self, x, events, mask=None):
        image = x
