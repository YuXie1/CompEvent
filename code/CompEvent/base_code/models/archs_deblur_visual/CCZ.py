...
class CCZ(nn.Module):
    ...
    def __init__(self, in_nc, out_nc, nf, unf, nb, scale=4):
        super(CCZ, self).__init__()
        # SCPA
        SCPA_block_f = functools.partial(ResnetGenerator,input_nc=10,output_nc=10)
        self.scale = scale
...
# my_model = PAN_Event_3(in_nc=3,out_nc=3,nf=10,unf=10,nb=2,scale=2)
